...
1. Install Homebrew packages `curl`, `libzip`, and `dylibbundler`: `brew install curl libzip dylibbundler`.
...
1. Download libpng sources and extract in php/ directory. See http://www.libpng.org/pub/png/libpng.html .
1. Download JPEG sources and extract in php/ directory. See https://www.ijg.org .
1. Download Oniguruma sources and extract in php/ directory. See https://github.com/kkos/oniguruma/releases .
1. Download PHP 8.5.10 sources and extract it in the "phpdesktop/php/" directory. See https://www.php.net/downloads.php .
...
1. Bundle Homebrew libraries before distributing the app:
   `dylibbundler -od -b -x "build_$(uname -m)/Release/PHP Desktop.app/Contents/MacOS/php-cgi" -d "build_$(uname -m)/Release/PHP Desktop.app/Contents/MacOS"`.

The PHP build enables mysqli, PDO SQLite, OpenSSL, mbstring, GD with PNG/JPEG,
DOM/XML, tokenizer, fileinfo, FTP, sockets, cURL, and ZIP.
